...
function getBuyTable(){
    ...
    db.outputbuytokens.each(function(token){
        ...
        if(token.notes != undefined){
            ...
            row += '<td>' + parseFloat(token.instantBuyPrice).toFixed(8) + '</td>';
            if(isNaN(averagePrice)){
                row += '<td>N/A</td>';
                row += '<td>N/A</td>';
            }
            else{
                row += '<td>' + averagePrice.toFixed(8) + '</td>';
                row += '<td>' + token.samples + '</td>';
            }
            row += '<td>' + parseFloat(token.buyMidPrice).toFixed(8) + '</td>';
...
function getSellTable(){
    ...
    db.outputselltokens.each(function(token){
        ...
        if(token.notes != undefined){
            ...
            row += '<td>' + parseFloat(token.instantSellPrice).toFixed(8) + '</td>';
            if(isNaN(averagePrice)){
                row += '<td>N/A</td>';
                row += '<td>N/A</td>';
            }
            ...
            row += '<td>' + parseFloat(token.sellMidPrice).toFixed(8) + '</td>';
